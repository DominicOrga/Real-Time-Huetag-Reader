...
void assignMarkers() {
	...
	_images[16777215] = new orga::videofile("C:\\Huetag\\LoL.mp4");

	_images[14] = new orga::spritesheet(cv::imread("C:\\Huetag\\yurnero.png", CV_LOAD_IMAGE_UNCHANGED));
	_images[140] = new orga::spritesheet(cv::imread("C:\\Huetag\\mirana.png", CV_LOAD_IMAGE_UNCHANGED));
	_images[1400] = new orga::spritesheet(cv::imread("C:\\Huetag\\traxex.png", CV_LOAD_IMAGE_UNCHANGED));
	_images[14000] = new orga::spritesheet(cv::imread("C:\\Huetag\\magina.png", CV_LOAD_IMAGE_UNCHANGED));
